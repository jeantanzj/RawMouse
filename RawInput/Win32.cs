...
namespace RawInput_dll
{
    static public class Win32
    {
        ...
        internal const int MOUSE_ATTRIBUTES_CHANGED = 0x04;
        internal const int MOUSE_MOVE_RELATIVE = 0;
        internal const int MOUSE_MOVE_ABSOLUTE = 1;
        internal const int MOUSE_VIRTUAL_DESKTOP = 0x02;
        internal const int RI_MOUSE_LEFT_BUTTON_DOWN = 0x0001;
        internal const int RI_MOUSE_LEFT_BUTTON_UP = 0x0002;
        internal const int RI_MOUSE_MIDDLE_BUTTON_DOWN = 0x0010;
        internal const int RI_MOUSE_MIDDLE_BUTTON_UP = 0x0020;
        internal const int RI_MOUSE_RIGHT_BUTTON_DOWN= 0x0004;
        internal const int RI_MOUSE_RIGHT_BUTTON_UP = 0x0008;
        internal const int RI_MOUSE_BUTTON_4_DOWN = 0x0040;
        internal const int RI_MOUSE_BUTTON_4_UP = 0x0080;
        internal const int RI_MOUSE_BUTTON_5_DOWN = 0x100;
        internal const int RI_MOUSE_BUTTON_5_UP = 0x0200;

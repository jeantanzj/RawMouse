...
namespace RawInput_dll
{
    public class RawInput : NativeWindow  
    {
        ...
        public  event RawMouse.DeviceEventHandler MouseClicked
        {
            add { _mouseDriver.MouseClicked += value; }
            remove { _mouseDriver.MouseClicked -= value;}
        }

        public int NumberOfKeyboards
        {
            get { return _mouseDriver.NumberOfMouse; } 
        }
